...
namespace MotionPlatformControl
{
    public class InputBox
    {
        ...
        private class InputBoxDialog : Form
        {
            ...
            #region Constructor
            public InputBoxDialog(string prompt, string title, string defaultValue = null, int? xPos = null, int? yPos = null, bool password = true)
            {
                ...
                _txtInput.UseSystemPasswordChar = password;
